...
export default function AdminPanel() {
  ...
  const handleStartEditClass = (c) => {
    ...
    // Parse schedule string: "Day | Date Year | Time"
      ...
      <div className="container">
        ...
        <div style={{
          ...
          <button 
            ...
            style={{
              padding: '10px 20px',
              borderRadius: '10px',
              background: activeTab === 'text' ? 'rgba(212,175,55,0.08)' : 'transparent',
              color: activeTab === 'text' ? '#d4af37' : 'var(--text-secondary)',
              border: activeTab === 'text' ? '1px solid rgba(212,175,55,0.3)' : '1px solid transparent',
              cursor: 'pointer',
              fontWeight: 600,
              fontSize: '0.9rem',
              display: 'flex',
          ...
          <button 
            ...
            style={{
              padding: '10px 20px',
              borderRadius: '10px',
              background: activeTab === 'gallery' ? 'rgba(99,102,241,0.08)' : 'transparent',
              color: activeTab === 'gallery' ? '#6366f1' : 'var(--text-secondary)',
              border: activeTab === 'gallery' ? '1px solid rgba(99,102,241,0.3)' : '1px solid transparent',
              cursor: 'pointer',
              fontWeight: 600,
              fontSize: '0.9rem',
              display: 'flex',
          ...
          <button 
            ...
            style={{
              padding: '10px 20px',
              borderRadius: '10px',
              background: activeTab === 'classes' ? 'rgba(16,185,129,0.08)' : 'transparent',
              color: activeTab === 'classes' ? '#10b981' : 'var(--text-secondary)',
              border: activeTab === 'classes' ? '1px solid rgba(16,185,129,0.3)' : '1px solid transparent',
              cursor: 'pointer',
              fontWeight: 600,
              fontSize: '0.9rem',
              display: 'flex',
          ...
          <button 
            ...
            style={{
              padding: '10px 20px',
              borderRadius: '10px',
              background: activeTab === 'commissions' ? 'rgba(255,255,255,0.04)' : 'transparent',
              color: activeTab === 'commissions' ? '#fff' : 'var(--text-secondary)',
              border: activeTab === 'commissions' ? '1px solid var(--border-color)' : '1px solid transparent',
              cursor: 'pointer',
              fontWeight: 600,
              fontSize: '0.9rem',
              display: 'flex',
          ...
          <button 
            ...
            style={{
              padding: '10px 20px',
              borderRadius: '10px',
              background: activeTab === 'users' ? 'rgba(255,255,255,0.04)' : 'transparent',
        ...
        {activeTab === 'text' && (
          <form onSubmit={handleUpdateCopy} className="glass-card glow-art" style={{ padding: '40px' }}>
            <h2 style={{ fontSize: '1.4rem', fontFamily: 'var(--font-heading)', color: '#fff', marginBottom: '24px' }}>
              📝 Edit Dynamic Text Copy
            </h2>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  <div className="form-group">
                    ...
                    <input type="text" className="form-control focus-art" value={heroTitle} onChange={(e)=>setHeroTitle(e.target.value)} required />
                  </div>
                  <div className="form-group">
                    <label className="form-label">Hero Subtitle</label>
                    <input type="text" className="form-control focus-art" value={heroSubtitle} onChange={(e)=>setHeroSubtitle(e.target.value)} required />
                  </div>
                  <div className="form-group">
                    <label className="form-label">Hero Description</label>
                    <textarea className="form-control focus-art" rows={3} value={heroDesc} onChange={(e)=>setHeroDesc(e.target.value)} required />
                  </div>
                </div>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '24px' }} className="grid-3">
                ...
                {/* Fine Arts Copy */}
                <div>
                  <h4 style={{ color: '#d4af37', borderBottom: '1px solid rgba(212,175,55,0.2)', paddingBottom: '6px', marginBottom: '16px' }}>Fine Arts Page</h4>
                  <div className="form-group">
                    <label className="form-label">Arts Page Title</label>
                    <input type="text" className="form-control focus-art" value={artTitle} onChange={(e)=>setArtTitle(e.target.value)} required />
                  </div>
                  <div className="form-group">
                    <label className="form-label">Arts Description</label>
                    <textarea className="form-control focus-art" rows={4} value={artDesc} onChange={(e)=>setArtDesc(e.target.value)} required />
                  </div>
                </div>

                {/* Skating Copy */}
                <div>
                  <h4 style={{ color: '#6366f1', borderBottom: '1px solid rgba(99,102,241,0.2)', paddingBottom: '6px', marginBottom: '16px' }}>Skating Page</h4>
                  <div className="form-group">
                    <label className="form-label">Skating Page Title</label>
                    <input type="text" className="form-control focus-skate" value={skateTitle} onChange={(e)=>setSkateTitle(e.target.value)} required />
                  </div>
                  <div className="form-group">
                    <label className="form-label">Skating Description</label>
                    <textarea className="form-control focus-skate" rows={4} value={skateDesc} onChange={(e)=>setSkateDesc(e.target.value)} required />
                  </div>
                </div>

                {/* Chess Copy */}
                <div>
                  <h4 style={{ color: '#10b981', borderBottom: '1px solid rgba(16,185,129,0.2)', paddingBottom: '6px', marginBottom: '16px' }}>Chess Page</h4>
                  <div className="form-group">
                    <label className="form-label">Chess Page Title</label>
                    <input type="text" className="form-control focus-chess" value={chessTitle} onChange={(e)=>setChessTitle(e.target.value)} required />
                  </div>
                  <div className="form-group">
                    <label className="form-label">Chess Description</label>
                    <textarea className="form-control focus-chess" rows={4} value={chessDesc} onChange={(e)=>setChessDesc(e.target.value)} required />
                  </div>
                </div>
              ...
              <div style={{ marginTop: '10px' }}>
                <h4 style={{ color: '#d4af37', borderBottom: '1px solid rgba(212,175,55,0.2)', paddingBottom: '6px', marginBottom: '16px' }}>
                  💰 Service & Membership Pricing
                </h4>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '20px' }} className="grid-4">
                  <div className="form-group">
                    <label className="form-label">Art Commission Base (Ksh)</label>
                    <input 
                      type="number" 
                      className="form-control focus-art" 
                      value={artBaseCommissionPrice} 
                      onChange={(e) => setArtBaseCommissionPrice(e.target.value)} 
                      required 
                    />
                  </div>
                  <div className="form-group">
                    <label className="form-label">Skating Annual Pass (Ksh)</label>
                    <input 
                      type="number" 
                      className="form-control focus-skate" 
                      value={skateMembershipPrice} 
                      onChange={(e) => setSkateMembershipPrice(e.target.value)} 
                      required 
                    />
                  </div>
                  <div className="form-group">
                    <label className="form-label">Chess Casual Pass (Ksh)</label>
                    <input 
                      type="number" 
                      className="form-control focus-chess" 
                      value={chessCasualPrice} 
                      onChange={(e) => setChessCasualPrice(e.target.value)} 
                      required 
                    />
                  </div>
                  <div className="form-group">
                    <label className="form-label">Chess Pro Pass (Ksh)</label>
                    <input 
                      type="number" 
                      className="form-control focus-chess" 
                      value={chessProPrice} 
                      onChange={(e) => setChessProPrice(e.target.value)} 
                      required 
                    />
                  </div>
                </div>
        ...
        {activeTab === 'gallery' && (
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: '30px' }} className="grid-2">
            ...
            <form onSubmit={handleAddArt} className="glass-card glow-art" style={{ height: 'fit-content' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div className="form-group">
                  <label className="form-label">Painting Title</label>
                  <input type="text" className="form-control focus-art" placeholder="E.g., Autumn Reflexes" value={newArtTitle} onChange={(e)=>setNewArtTitle(e.target.value)} required />
                </div>

                <div className="form-group">
                  <label className="form-label">Art Medium / Style</label>
                  <input type="text" className="form-control focus-art" placeholder="E.g., Oil pastels on board" value={newArtMedium} onChange={(e)=>setNewArtMedium(e.target.value)} required />
                </div>

                <div className="form-group">
                  <label className="form-label">Selling Price (Ksh)</label>
                  <input type="number" className="form-control focus-art" placeholder="E.g., 25000" value={newArtPrice} onChange={(e)=>setNewArtPrice(e.target.value)} required />
                </div>

                <div className="form-group">
                  <label className="form-label">Description / Philosophy</label>
                  <textarea className="form-control focus-art" rows={3} placeholder="Contextual insights..." value={newArtDesc} onChange={(e)=>setNewArtDesc(e.target.value)} required />
                </div>

                {/* Secure File Uploader vs Text URL Option */}
                <div className="form-group">
                ...
                <button type="submit" className="btn btn-gold" style={{ marginTop: '10px' }}>
                  <Plus size={16} /> Post to Gallery
                </button>
              </div>
            </form>

            {/* Right: Gallery Grid View */}
            <div className="glass-card" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              <h3 style={{ fontSize: '1.2rem', fontFamily: 'var(--font-heading)', color: '#fff' }}>
                🖼️ Gallery Archives ({gallery.length})
              </h3>
                    ...
                    {editingArtId === art.id ? (
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', width: '100%' }}>
                        ...
                        <div className="form-group">
                          <input 
                            ...
                            className="form-control focus-art" 
                            value={editArtMedium} 
                            onChange={(e) => setEditArtMedium(e.target.value)} 
                            placeholder="Art Medium / Style"
                            required 
                          />
                        </div>
                        ...
                        <textarea 
                          className="form-control focus-art" 
                          value={editArtDesc} 
                          onChange={(e) => setEditArtDesc(e.target.value)} 
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '16px', width: '100%', justifyContent: 'space-between', flexWrap: 'wrap' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                          ...
                          />
                          <div>
                            <h4 style={{ color: '#fff', fontSize: '0.95rem', margin: 0 }}>{art.title}</h4>
                            <div style={{ display: 'flex', gap: '8px', alignItems: 'center', marginTop: '4px' }}>
                              <span className="badge badge-art" style={{ fontSize: '0.65rem' }}>{art.medium}</span>
                              <span style={{ color: 'var(--text-muted)', fontSize: '0.8rem' }}>Ksh {art.price.toLocaleString()}</span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                          <button 
                            onClick={() => handleToggleSold(art.id, art.isSold)}
                            className={`btn ${art.isSold ? 'btn-secondary' : 'btn-gold'}`}
                            style={{ padding: '6px 12px', fontSize: '0.75rem' }}
                          >
                            {art.isSold ? 'Set Available' : 'Set Sold'}
                          </button>
                          <button 
            ...
            <form onSubmit={handleAddClass} className="glass-card glow-skate" style={{ height: 'fit-content' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div className="form-group">
                  ...
                  >
                    <option value="fine-arts">Fine Arts Studio</option>
                    <option value="skating">Skating Academy</option>
                ...
                <div className="form-group">
                  ...
                  <input type="text" className="form-control focus-skate" placeholder="E.g., Pastel Landscape Flow" value={newClassTitle} onChange={(e)=>setNewClassTitle(e.target.value)} required />
                </div>

                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '10px' }} className="grid-3">
                  <div className="form-group">
                    <label className="form-label">Day</label>
                    <input type="text" className="form-control focus-skate" placeholder="E.g., Sunday" value={newClassDay} onChange={(e)=>setNewClassDay(e.target.value)} required />
                  </div>
                  <div className="form-group">
                    <label className="form-label">Date & Year</label>
                    <input type="text" className="form-control focus-skate" placeholder="E.g., Oct 12, 2026" value={newClassDate} onChange={(e)=>setNewClassDate(e.target.value)} required />
                  </div>
                  <div className="form-group">
                    <label className="form-label">Time Range</label>
                    <input type="text" className="form-control focus-skate" placeholder="E.g., 3:00 PM - 4:30 PM" value={newClassTime} onChange={(e)=>setNewClassTime(e.target.value)} required />
                  </div>
                </div>

                <div className="form-group">
                  <label className="form-label">Price per Session (Ksh)</label>
                  <input type="number" className="form-control focus-skate" placeholder="E.g., 1500" value={newClassPrice} onChange={(e)=>setNewClassPrice(e.target.value)} required />
                </div>

                <div className="form-group">
                  <label className="form-label">Short Description</label>
                  <textarea className="form-control focus-skate" rows={3} placeholder="Course goals..." value={newClassDesc} onChange={(e)=>setNewClassDesc(e.target.value)} required />
                </div>

                <button type="submit" className="btn btn-indigo" style={{ marginTop: '10px' }}>
                  <Plus size={16} /> Post Class
                </button>
              </div>
            </form>

            {/* Right: Courses Grid View */}
            <div className="glass-card" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              <h3 style={{ fontSize: '1.2rem', fontFamily: 'var(--font-heading)', color: '#fff' }}>
                📚 Current Active Classes ({classes.length})
              </h3>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                {classes.map(c => (
                  <div key={c.id} style={{
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', width: '100%' }}>
                        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '12px' }} className="grid-2">
                          ...
                          <input 
                            type="number" 
                            className="form-control focus-skate" 
                            value={editClassPrice} 
                            onChange={(e) => setEditClassPrice(e.target.value)} 
                            placeholder="Price (Ksh)"
                            required 
                          />
                        </div>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '8px' }} className="grid-3">
                          ...
                          <div>
                            <label style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>Date & Year</label>
                            <input 
                              type="text" 
                              className="form-control focus-skate" 
                              value={editClassDate} 
                          ...
                          <div>
                            <label style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>Time Range</label>
                            <input 
                              type="text" 
                              className="form-control focus-skate" 
                              value={editClassTime} 
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '12px', width: '100%', flexWrap: 'wrap' }}>
                        <div>
                          <div style={{ display: 'flex', gap: '6px', alignItems: 'center', marginBottom: '4px' }}>
                            <span className={`badge ${c.category === 'fine-arts' ? 'badge-art' : c.category === 'skating' ? 'badge-skate' : 'badge-chess'}`} style={{ fontSize: '0.6rem' }}>
                              {c.category}
                            </span>
                          </div>
                          <h4 style={{ color: '#fff', fontSize: '0.95rem', margin: 0 }}>{c.title}</h4>
                          <p style={{ color: 'var(--text-muted)', fontSize: '0.78rem', margin: '4px 0 0 0' }}>
                            Timeline: <span style={{ color: '#fff' }}>{c.schedule}</span> | Price: <span style={{ color: '#fff' }}>Ksh {c.price.toLocaleString()}</span>
                          </p>
                        </div>
        ...
        {activeTab === 'commissions' && (
          <div className="glass-card" style={{ padding: '30px' }}>
            <h3 style={{ fontSize: '1.2rem', fontFamily: 'var(--font-heading)', color: '#fff', marginBottom: '24px' }}>
              🎨 Portrait Commission Queue ({commissions.length})
            </h3>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                <div key={comm.id} style={{
                  ...
                  <div>
                    <div style={{ display: 'flex', gap: '8px', alignItems: 'center', marginBottom: '8px' }}>
                      ...
                      <span className="badge badge-gray">{comm.size}</span>
                      <span style={{ color: 'var(--text-muted)', fontSize: '0.8rem' }}>by {comm.userName}</span>
                    </div>
                    <p style={{ color: '#fff', fontSize: '0.95rem', margin: '0 0 10px 0', fontWeight: 500 }}>
                      "{comm.description}"
                    </p>
                    <div style={{ color: 'var(--text-muted)', fontSize: '0.8rem' }}>
                      Target Delivery: {comm.targetDate} | Request ID: {comm.id}
                    </div>
                  </div>

                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', justifyContent: 'center', alignItems: 'flex-end' }}>
                    <div style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', marginBottom: '4px' }}>
                      Status: <span style={{ color: comm.status === 'Pending Review' ? '#f59e0b' : '#10b981', fontWeight: 600 }}>{comm.status}</span>
                    </div>
                    
                    <div style={{ display: 'flex', gap: '8px' }}>
                      <button 
                        onClick={() => handleUpdateCommissionStatus(comm.id, 'In Progress')}
                        className="btn btn-secondary"
                        style={{ padding: '6px 12px', fontSize: '0.75rem' }}
                      >
                        Start Work
                      ...
                      <button 
                        onClick={() => handleUpdateCommissionStatus(comm.id, 'Completed')}
                        className="btn btn-emerald"
                        style={{ padding: '6px 12px', fontSize: '0.75rem' }}
                      >
              ...
              {commissions.length === 0 && (
                <div style={{ padding: '60px 0', textAlign: 'center', color: 'var(--text-muted)' }}>
                  No portrait commission requests in the active queue.
                </div>
              )}
            </div>
          </div>
        ...
        {activeTab === 'users' && (
          <div className="glass-card" style={{ padding: '30px' }}>
            <h3 style={{ fontSize: '1.2rem', fontFamily: 'var(--font-heading)', color: '#fff', marginBottom: '24px' }}>
              👤 Registered TCM Arts Members ({users.length})
            </h3>
